# `Minuit2_Julia_Wrapper_jll.jl` (v0.3.0+0)

[![deps](https://juliahub.com/docs/Minuit2_Julia_Wrapper_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Minuit2_Julia_Wrapper_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/89e01de56f3189f7033207d9cf59a7892bc20869/M/Minuit2_Julia_Wrapper/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaHEP/Minuit2_Julia_Wrapper.git (revision: `075d1140a428c15d4eef8c3d24c9227e4f337feb`)
...
* `FileProduct`: `Minuit2_exports`
* `LibraryProduct`: `libMinuit2Wrap`
